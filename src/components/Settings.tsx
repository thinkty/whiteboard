...
export const Settings = (props: Props): JSX.Element => {
  ...
  const { primaryColor, backgroundColor } = extractSettings(props.currentSettings); // TODO: showgrid
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {
              Object.entries(props.currentSettings).map(([key, entry]: [string, SettingsEntryT]): JSX.Element => (
                <SettingsEntry
                  key={key}
                  entryKey={key}
                  entry={entry}
